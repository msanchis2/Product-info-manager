...
import { getData, deleteIntegracion} from '../store/action'
...
const CustomHeader = ({ handleFilter, searchterm, handlePerPage, rowsPerPage }) => {
  ...
  const ultimoCsv = () => {
    ...
    a.setAttribute('download', 'copia'.concat('_PIM.csv'))
    a.click()
  }
    ...
    <div className='invoice-list-table-header w-100 py-2'>
      <Row>
        <Col lg='6' className='d-flex align-items-center px-0 px-lg-1'>
          ...
          <Can I="Integracion" a="PIM" field="Nuevo">
            <Button.Ripple tag={Link} to='/integracion/new' color='primary'>
              <FormattedMessage id="Nuevo"></FormattedMessage>
            </Button.Ripple>
          </Can>
          <Button.Ripple onClick={ultimoCsv} color='primary' className='ml-2'>
            <FormattedMessage id="Última descarga"></FormattedMessage>
          </Button.Ripple>
        </Col>
        <Col
          lg='6'
...
const integracionsList = () => {
  ...
  if (!ability.can("Integracion", "PIM", "Ver")) {
    return null
  }
    ...
    <Fragment>
      <Card>
        <DataTable
          ...
          responsive
          paginationServer
          columns={columns(store, handleDeleteModal) }
...
export default integracionsList
