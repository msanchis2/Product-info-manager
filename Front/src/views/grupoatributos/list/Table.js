...
import { deleteGrupoatributo, getData } from '../store/action'
    ...
    <div className='invoice-list-table-header w-100 py-2'>
      <Row>
        <Col lg='6' className='d-flex align-items-center px-0 px-lg-1'>
          ...
          <Can I="GrupoAtributos" a="PIM" field="Nuevo">
            <Button.Ripple tag={Link} to='/grupo-atributos/new' color='primary'>
...
const GrupoatributosList = () => {
  ...
  const getDeleteMessage = () => {
    const selectedGrupoatributo = store.data.find(grupoatributo => grupoatributo.id === toDelete)
    return `¿Realmente desea eliminar el registro ${selectedGrupoatributo?.nombre}?`
  }

  // ** Modal Title
  const getDeleteTitle = () => {
    return intl.formatMessage({ id: 'Borrar Grupo de Atributo' })
  }
