...
export class UsuariosController {
  ...
  async updateById(
    ...
    if (usuarios.password && usuarios.password.length > 6) usuarios.password = await this.hasher.hashPassword(usuarios.password)
    else delete usuarios.password
